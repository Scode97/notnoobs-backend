...
from feed.views import UserCreateAPIView, FilteredPlaces,GetEvent, PhysicalActivitiesList, CategoryDetailView, QuestionDetail, AnswerDetail, PlaceList, EventList, GetBooking, CreateBooking
