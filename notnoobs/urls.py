...
from feed.views import UserCreateAPIView, FilteredPlaces, PhysicalActivitiesList, CategoryDetailView, QuestionDetail, AnswerDetail, PlaceList, EventList, GetBooking, CreateBooking
